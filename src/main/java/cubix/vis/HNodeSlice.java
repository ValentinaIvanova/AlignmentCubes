...
/**
 *  Horizontal node slice. 
 *  Slice is not used in other views, rather to allow rotation in the 
 *  side view.
 *  
 * @author benjamin.bach@inria.fr
 *
 */
public class HNodeSlice extends Slice<CNode, CTime> {

	public HNodeSlice(MatrixCube matrixCube, int rowCount, int colCount, Object data) 
	{
	...
	{
		float x = (row - (rowCount-1) / 2.0f) * CubixVis.CELL_UNIT;
		float y = 0f;
...
//				gl.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, CubixVis.COLOR_TIME_END.clone(), 0);
...
//				gl.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, CubixVis.COLOR_TIME_START.clone(), 0);
...
//				gl.glColor4fv(CubixVis.COLOR_TIME_START.clone(), 0);
				gl.glVertex3f(cornerVertices[0][X], cornerVertices[0][Y], cornerVertices[0][Z]);
//				gl.glColor4fv(CubixVis.COLOR_TIME_END.clone(), 0);
				gl.glVertex3f(cornerVertices[1][X], cornerVertices[1][Y], cornerVertices[1][Z]);
//				gl.glColor4fv(CubixVis.COLOR_TIME_START.clone(), 0);
				gl.glVertex3f(cornerVertices[3][X], cornerVertices[3][Y], cornerVertices[3][Z]);
//				gl.glColor4fv(CubixVis.COLOR_TIME_END.clone(), 0);
...
//				gl.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, CubixVis.COLOR_AXIS_NODE.clone(), 0);
				gl.glVertex3f(cornerVertices[0][X], cornerVertices[0][Y], cornerVertices[0][Z]);
				gl.glVertex3f(cornerVertices[4][X], cornerVertices[4][Y], cornerVertices[4][Z]);
				gl.glVertex3f(cornerVertices[1][X], cornerVertices[1][Y], cornerVertices[1][Z]);
				gl.glVertex3f(cornerVertices[5][X], cornerVertices[5][Y], cornerVertices[5][Z]);
